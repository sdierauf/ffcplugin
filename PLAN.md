...
- Lightroom matching: the correction profile now defaults to 70th-percentile flat-field normalization, which reduced mean raw-mosaic difference from Lightroom's sample DNGs from about 28.9 DN to 21.1 DN while keeping dark film-mask/rebate regions effectively unchanged.
