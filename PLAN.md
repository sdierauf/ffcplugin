...
- Lightroom Python-pipeline helper: implemented in `scripts/run_ffc_apply.py` and exposed through `Library > Plug-in Extras > Flat Field Correction...` > `Apply Python Pipeline...`.
